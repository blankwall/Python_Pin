...
void RTN_IPOINT_AFTER(
    ...
    PyDict_SetItemString(everything, "reg_gax", Py_BuildValue("k", reg_gax));
    PyDict_SetItemString(everything, "reg_gbx", Py_BuildValue("k", reg_gbx));
    PyDict_SetItemString(everything, "reg_gcx", Py_BuildValue("k", reg_gcx));
    PyDict_SetItemString(everything, "reg_gdx", Py_BuildValue("k", reg_gdx));
    PyDict_SetItemString(everything, "reg_gbp", Py_BuildValue("k", reg_gbp));
    PyDict_SetItemString(everything, "reg_gsp", Py_BuildValue("k", reg_gsp));
    PyDict_SetItemString(everything, "reg_gdi", Py_BuildValue("k", reg_gdi));
    PyDict_SetItemString(everything, "reg_gsi", Py_BuildValue("k", reg_gsi));
